...
public enum Mob {
	...
	public CraftEntity spawn(org.bukkit.entity.Player player, CraftEssence plugin) throws MobException {
		try {
			...
			CraftEssence.log.log(java.util.logging.Level.SEVERE,"Unable to spawn mob. Error: ");
			e.printStackTrace();
